...
const Services = () => {
  ...
  const markAsUnpaid = () => {
    setServices(prev => prev.map(s => s.id === selectedService.id ? { ...s, paymentStatus: "Awaiting Credit", amountPaid: 0, status: "pending" } : s))
    setSelectedService(prev => ({ ...prev, paymentStatus: "Awaiting Credit", amountPaid: 0, status: "pending" }))
    setToastMessage("Marked as Awaiting Credit")
    setShowToast(true)
    setTimeout(() => setShowToast(false), 3000)
  }
  ...
  return (
    <div className="min-h-screen p-2 border-slate-300 bg-slate-100">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg border border-slate-300 overflow-hidden">
          ...
          {mainTab === "services" && (
            <>
              <div className="border-b border-slate-300 bg-slate-50 flex overflow-x-auto">
                {statusTabs.map((tab) => (
              ...
              <div className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                  {filteredServices.map((service) => (
                    <div key={service.id} className="bg-white border border-slate-300 rounded-lg p-3 hover:shadow-md transition-shadow relative">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="relative">
                            ...
                            {showStatusMenu === service.id && (
                              <div className="absolute right-0 top-full mt-1 w-44 bg-white rounded-lg shadow-xl border border-slate-300 z-20">
          ...
          {mainTab === "details" && selectedService && (
            <div className="p-6 max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-lg border p-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-4 py-1.5 rounded-full text-sm font-medium ${selectedService.paymentStatus === "paid" ? "bg-green-100 text-green-700 border border-green-300" : "bg-red-100 text-red-700 border border-red-300"}`}>
                          {selectedService.paymentStatus === "paid" ? "✓ Paid" : "⚠ Awaiting Credit"}
                        </span>
                      </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      }} color="green" icon={<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>}>Paid</Button>
                      <Button onClick={markAsUnpaid} color="yellow" icon={<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>}>Awaiting Credit</Button>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg w-72 text-center">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <Button
                        onClick={() => {
                          markAsPaid("cash");
                          setShowPaymentType(false); // auto close
                        }}
                        color="green"
                      >
                        Cash
                    ...
                    <button
                      ...
                      onClick={() => setShowPaymentType(false)}
                    >
                      Cancel
                    </button>
                  </div>
              ...
              <div className="flex justify-end gap-5">
                <Button onClick={() => handleSendWhatsApp(selectedService)} color="blue" icon="">Generate Invoice</Button>
